...
class User implements UserInterface
{
    ...
    /**
     * @ORM\ManyToOne(targetEntity="App\Entity\BoardMemberFunction", inversedBy="users")
     * @ORM\JoinColumn(nullable=true)
     */
    private $function;

    /**
     * @ORM\OneToMany(targetEntity="App\Entity\Vote", mappedBy="voteAuthor")
     */
    private $votes;
    ...
    public function getFunction(): ?BoardMemberFunction
    {
        return $this->function;
    }

    public function setFunction(?BoardMemberFunction $function): self
    {
    ...
    public function removeVote(Vote $vote): self
    {
        if ($this->votes->contains($vote)) {
            ...
            if ($vote->getVoteAuthor() === $this) {
                $vote->setVoteAuthor(null);
            }
        }
